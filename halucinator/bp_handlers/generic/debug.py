...
from halucinator.bp_handlers.intercepts import register_bp_handler
...
class IPythonShell(BPHandler):
    ...
    def get_value(self, target, addr):
        ...
        print("In Debug: %s" % self.addr2name[addr])
        ...
        print("You can look up a symbol using target.get_symbol_name(addr)")

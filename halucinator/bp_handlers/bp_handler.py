...
'''basic break point handler. Holds the decorator and if no register_handler
is provided by classes inheriting from, then use this one'''

from functools import wraps

from ghaldra_utils.ghaldra_utils import *
...
class BPHandler(object):
    '''parent class to register bp handlers'''
